	        ...
	        <?php if($work->status == '1'): ?>
	        	<div class="widget-block btn-widget">
	              	...
	              	<a href="#" class="btn btn-primary img-like <?php echo e($work->isLiked == 1 ? 'active' : null); ?>" data-like="<?php echo e($work->id); ?>"
	              	 title="Like"><i class="fas fa-heart"></i> <span><?php echo e($work->likes()->count()); ?></span></a>
	              	<a href="#" class="btn btn-primary img-fav <?php echo e($work->isFavorite == 1 ? 'active' : null); ?>" data-fav="<?php echo e($work->id); ?>" title="Collection"><i class="fas fa-plus"></i> <span><?php echo e($work->favorites()->count()); ?></span> </a>
	              <?php else: ?>
	              	<a href="<?php echo e(route('login')); ?>" class="btn btn-primary" title="like"><i class="fas fa-heart"></i> <span><?php echo e($work->likes()->count()); ?></span></a>
	              	<a href="<?php echo e(route('login')); ?>" class="btn btn-primary" title="Collection"><i class="fas fa-plus"></i> <span><?php echo e($work->favorites()->count()); ?></span> </a>
	              <?php endif; ?>
	              <a href="<?php echo e(asset('images/work/'.$work->workphotos->first()->images)); ?>" data-id="<?php echo e($work->id); ?>" class="btn btn-primary img-download" download><i class="fas fa-download"></i> <span><?php echo e($work->download); ?></span> </a>
								<?php														
	              ...
	              <div class="share-button">
	              	<a class="btn btn-primary share-btn"><i class="fas fa-share-alt"></i></a>

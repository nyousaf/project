      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(url('admin/social')); ?>"><i class="material-icons">label_outline</i>Social</a></li>
        ...
        <li class="treeview">
          <a href="#" class="<?php echo e(Nav::isResource('user')); ?>">
            <i class="material-icons">build</i> <span>user</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo e(route('txt.user')); ?>"><i class="material-icons">label_outline</i> User</a></li>
          </ul>
        </li> 

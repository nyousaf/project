          ...
          <div class="row">
            <div class="col-md-4">
              <div class="profile-block text-center">
                ...
                <?php if(auth()->guard()->check()): ?>
                  <button type="button" id="follow-btn" class="btn btn-primary profile-follow" data-follow="<?php echo e($user->id); ?>"><?php echo e($user->followers()->where('follower_id', $auth->id)->first() ? 'Unfollow' : 'Follow'); ?></button>
                <?php else: ?>
            ...
            <div class="col-md-8">
              <div class="profile-dtl">
                <h6 class="username"><?php echo e($user->name); ?></h6>
                <div class="join-date">Joined on <?php echo e($user->created_at->format('jS F, Y')); ?></div>
                <p><?php echo e($user->brief); ?></p>
                <ul>
                  <li><i class="fa fa-user"></i> Photos : <?php echo e($user->works->count()); ?></li>
                  <li><i class="fa fa-user"></i> Collection : <?php echo e($user->user_favorites->count()); ?></li>
                  <li><i class="fa fa-user"></i> Followers : <?php echo e($user->followers->count()); ?></li>
                  <li><i class="fa fa-user"></i> Followings : <?php echo e($user->followings->count()); ?></li>

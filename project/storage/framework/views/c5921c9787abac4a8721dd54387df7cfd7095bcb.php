            ...
            <div class="col-md-4">
              <div class="profile-block text-center">
                ...
                <?php if(auth()->guard()->check()): ?>
                  <button type="button" id="follow-btn" class="btn btn-primary" data-follow="<?php echo e($user->id); ?>"><?php echo e($user->followers()->where('follower_id', $auth->id)->first() ? 'Unfollow' : 'Follow'); ?></button>
                <?php else: ?>

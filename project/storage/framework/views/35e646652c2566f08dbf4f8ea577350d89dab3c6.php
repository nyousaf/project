<?php $__env->startSection('content'); ?>
  <div class="content-main-block  mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="<?php echo e(route('work.create')); ?>" class="btn btn-danger btn-md">Add Work</a>
      <!-- Delete Modal -->
          ...
          <tbody>
            <?php $__currentLoopData = $work; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td><?php echo e($item->price ? $item->price : '-'); ?></td>
                <td><?php echo e($item->status == '1' ? 'Published' : 'Unpublished'); ?></td>                
                <td><?php echo e($item->created_at); ?></td>
                <td>
                  <div class="admin-table-action-block">
                    <a href="<?php echo e(route('work.edit', $item->id)); ?>" data-toggle="tooltip" data-original-title="Edit" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
                    <!-- Delete Modal -->

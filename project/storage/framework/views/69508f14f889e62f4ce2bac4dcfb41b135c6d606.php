              ...
              <tr>
                ...
                <td>
                  <div class="admin-table-action-block">
                    <a href="<?php echo e(route('faq.edit', $item->id)); ?>" data-toggle="tooltip" data-original-title="Edit" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
                    <!-- Delete Modal -->
                    ...
                    <div id="<?php echo e($item->id); ?>deleteModal" class="delete-modal modal fade" role="dialog">
                      <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <?php echo Form::open(['method' => 'DELETE', 'action' => ['FAQController@destory', $item->id]]); ?>

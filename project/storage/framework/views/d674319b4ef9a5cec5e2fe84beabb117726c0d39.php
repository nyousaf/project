      ...
      <div class="row admin-form-block z-depth-1">
        <div class="col-md-6">
          ...
          <div class="form-group<?php echo e($errors->has('tag') ? ' has-error' : ''); ?>">
              ...
              <?php echo Form::select('tag[]', $tags, $ta, ['class' => 'form-control, select2', 'multiple' => 'multiple']); ?>
          ...
          <div class="form-group<?php echo e($errors->has('on_sale') ? ' has-error' : ''); ?> switch-main-block">
            <div class="row">
              ...
              <div class="col-xs-5 pad-0">
                <label class="switch">                
                  <?php echo Form::checkbox('on_sale', null, null, ['class' => 'checkbox-switch']); ?>
          ...
          <div class="form-group<?php echo e($errors->has('status') ? ' has-error' : ''); ?> switch-main-block">
            <div class="row">
              ...
              <div class="col-xs-5 pad-0">
                <label class="switch">                
                  <?php echo Form::checkbox('status', null, null, ['class' => 'checkbox-switch']); ?>

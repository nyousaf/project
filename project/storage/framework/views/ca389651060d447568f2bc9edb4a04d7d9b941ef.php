        	...
        	<div class="col-lg-6">
				<div class="contact-block contact-desc"> 
            		...
            		<li>
            			...
            			<p><?php echo e($general->w_address); ?></p>
            		</li>
            	</ul>
            	<ul class="contact-dtl">
            		...
            		<li>
            			...
            			<p><a href="tel:<?php echo e($general->w_phone); ?>"><?php echo e($general->w_phone); ?></a></p>
            		</li>
            	</ul>
            	<ul class="contact-dtl">
            		...
            		<li>
            			...
            			<p><a href="mailto:<?php echo e($general->w_email); ?>?Subject=Hello%20again" target="_top"><?php echo e($general->w_email); ?></a></p>
            		</li>
            	</ul>
            	<ul class="contact-dtl">

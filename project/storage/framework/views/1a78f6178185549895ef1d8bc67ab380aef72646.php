				...
				<?php endif; ?>
      			...
      			<div class="row">
      				<div class="col-md-6">
    						...
    						<?php endif; ?>	
    						<div class="form-group<?php echo e($errors->has('paypal_id') ? ' has-error' : ''); ?>">
									<?php echo Form::label('paypal_id', 'Paypal Me Link'); ?>

									<?php echo Form::url('paypal_id',$auth->socials ? $auth->socials->paypal_id : null, ['class' => 'form-control','placeholder' => 'https://www.paypal.me/clickstocks']); ?>

									<small class="text-danger"><?php echo e($errors->first('paypal_id')); ?></small>

	...
	<div class="container">
		<div class="row">
            ...
            <button type="submit" class="btn btn-primary login-btn">Register Now</button>
	      		<a href="<?php echo e(url('/auth/facebook')); ?>" class="btn btn-primary fb-btn" title="Register With Facebook"><i class="fa fa-facebook"></i>Register With Facebook</a>
	      		<a href="<?php echo e(url('/auth/google')); ?>" class="btn btn-primary gplus-btn" title="Register With Google"><i class="fa fa-google"></i>Register With Google</a>
					</form>
				</div>
			</div>
		</div>

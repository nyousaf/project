<?php $__env->startSection('content'); ?>
  <div class="admin-form-main-block mrgn-t-40">
    <h4 class="admin-form-text"><a href="<?php echo e(url('admin/photos')); ?>" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Edit Photos</h4> 
    <?php echo Form::model($work, ['method' => 'PATCH', 'action' => ['WorkController@update', $work->id], 'files' => true]); ?>
      ...
      <div class="row admin-form-block z-depth-1">
        <div class="col-md-6">
          ...
          <div class="form-group">
            <select name="lic_id" class="form-control">
              ...
              <?php $__currentLoopData = App\License::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

             
              
                <option value="<?php echo e($lic->id); ?>" <?php echo e($work->lic_id == $lic->id ? "selected" : ""); ?>><?php echo e($lic->title); ?></option>
          ...
          <div class="form-group">
              ...
              <input type="text" name="meta_tag" value="<?php echo e($work->meta_tag); ?>" class="form-control" placeholder="Enter keyword by comma">
            </div>
  
            <div class="form-group">
              <label>Meta Description: </label>
              <textarea name="meta_desc" cols="30" rows="10" class="form-control"><?php echo e($work->meta_desc); ?></textarea>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
              <label>Model:</label>
              <input type="text" class="form-control" value="<?php echo e($work->model); ?>" name="model" placeholder="Enter Model No">
            </div>
  
            <div class="form-group">
                <label>Dimension:</label>
                <input name="dimension" type="text" value="<?php echo e($work->dimension); ?>" class="form-control" placeholder="ex. 2000x2000">
            </div>
            
            <div class="form-group">
              <label>Aperture:</label>
              <input name="aperture" type="text" value="<?php echo e($work->aperture); ?>" class="form-control" placeholder="ex. f2.0">
            </div>
            
            <div class="form-group">
              <label>Focal Length:</label>
              <input type="text" name="focal_len" value="<?php echo e($work->focal_len); ?>" class="form-control" placeholder="ex. 28mm">
            </div>
  
            <div class="form-group">
              <label>ISO:</label>
              <input type="text" name="iso" value="<?php echo e($work->iso); ?>" class="form-control" placeholder="ex. ISO800">
            </div>
  
            <div class="form-group">
              <label>Shutter Speed:</label>
              <input type="text" name="shutter_speed" value="<?php echo e($work->shutter_speed); ?>" class="form-control" placeholder="ex. 1/4000th">
            </div>

	...
	<div class="container">
		<div class="row">
          ...
          <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <a href="<?php echo e(url('/auth/facebook')); ?>" class="btn btn-primary fb-btn" title="Register With Facebook"><i class="fab fa-facebook-f"></i>Login With Facebook</a>
            <a href="<?php echo e(url('/auth/google')); ?>" class="btn btn-primary gplus-btn" title="Register With Google"><i class="fab fa-google"></i>Login With Google</a>
    			</form>      
        </div>
					<!-- Form End-->
			</div>

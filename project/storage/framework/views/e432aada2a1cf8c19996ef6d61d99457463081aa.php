<?php $__env->startSection('content'); ?>
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="<?php echo e(route('lic.create')); ?>" class="btn btn-danger btn-md"><i class="material-icons left">add</i> Create License</a>
      <!-- Delete Modal -->
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <?php echo Form::open(['method' => 'POST', 'action' => 'LicenseController@bulk_delete', 'id' => 'bulk_delete_form']); ?>
    ...
    <div class="content-block box-body">
      <table id="full_detail_table" class="table table-hover table-responsive">
        ...
        <?php if($lics): ?>
          <tbody>
            <?php $__currentLoopData = $lics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td>
                  <div class="inline">
                ...
                <td><?php echo substr(strip_tags($item->desc), 0, 50); ?>...</td>
               
                <td>
                  <div class="admin-table-action-block">
                    <a href="<?php echo e(route('lic.edit', $item->id)); ?>" data-toggle="tooltip" data-original-title="Edit" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
                    <!-- Delete Modal -->
                    ...
                    <div id="<?php echo e($item->id); ?>deleteModal" class="delete-modal modal fade" role="dialog">
                      <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <?php echo Form::open(['method' => 'DELETE', 'action' => ['LicenseController@destory', $item->id]]); ?>

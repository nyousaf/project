                  ...
                  <div class="col-lg-4 work-img-block">
                    <div class="work-block">
                      <a href="<?php echo e(url('photos/'.$item->uni_id.'/'.$item->slug)); ?>" title="<?php echo e($item->title); ?>">
                        ...
                        <a href="#" data-toggle="modal" data-target="#<?php echo e($item->id); ?>deleteModal" class="btn btn-white close-btn" data-id="<?php echo e($item->id); ?>" title="Remove"><i class="fa fa-trash" aria-hidden="true"></i></a>

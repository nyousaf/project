<?php $__env->startSection('content'); ?>
  <div class="content-main-block  mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="<?php echo e(route('gallery.create')); ?>" class="btn btn-danger btn-md">Add Gallery</a>
    <!-- Delete Modal -->
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <?php echo Form::open(['method' => 'POST', 'action' => 'GalleryController@bulk_delete', 'id' => 'bulk_delete_form']); ?>
              ...
              <tr>
                ...
                <td>
                  <?php if($item->image != null): ?>
                    <img src="<?php echo e(asset('images/gallery/'.$item->image)); ?>" class="img-responsive" width="80" alt="image">
                  <?php else: ?>
                    N/A  
                  <?php endif; ?>
                </td>
                ...
                <td>
                  <div class="admin-table-action-block">
                    <a href="<?php echo e(route('gallery.edit', $item->id)); ?>" data-toggle="tooltip" data-original-title="Edit" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
                    <!-- Delete Modal -->
                    ...
                    <div id="<?php echo e($item->id); ?>deleteModal" class="delete-modal modal fade" role="dialog">
                      <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <?php echo Form::open(['method' => 'DELETE', 'action' => ['GalleryController@destroy', $item->id]]); ?>

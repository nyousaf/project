<?php $__env->startSection('content'); ?>
  <div class="admin-form-main-block mrgn-t-40">
    <h4 class="admin-form-text"><a href="<?php echo e(url('admin/work')); ?>" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Add Work</h4> 
      ...
      <div class="row admin-form-block z-depth-1">
        <div class="col-md-6">
          ...
          <div class="form-group<?php echo e($errors->has('tag') ? ' has-error' : ''); ?>">
              ...
              <?php echo Form::select('tag[]', $tags, null, ['class' => 'form-control select2', 'multiple' => 'multiple']); ?>
          ...
          <div class="form-group<?php echo e($errors->has('on_sale') ? ' has-error' : ''); ?> switch-main-block">
            <div class="row">
              <div class="col-xs-4">
                <?php echo Form::label('on_sale', 'On Sale'); ?>

              </div>
              <div class="col-xs-5 pad-0">
                <label class="switch">                
                  <?php echo Form::checkbox('on_sale', 0, null, ['class' => 'checkbox-switch']); ?>
            ...
            <div class="col-xs-12">
              <small class="text-danger"><?php echo e($errors->first('on_sale')); ?></small>
            </div>
          </div>                           
          <div class="form-group<?php echo e($errors->has('status') ? ' has-error' : ''); ?> switch-main-block">
            <div class="row">
              ...
              <div class="col-xs-5 pad-0">
                <label class="switch">                
                  <?php echo Form::checkbox('status', 1, 1, ['class' => 'checkbox-switch']); ?>
          ...
          <div class="form-group<?php echo e($errors->has('images') ? ' has-error' : ''); ?> input-file-block">
            <?php echo Form::label('images', 'Work Images'); ?> - <p class="inline info">Help block text</p>
            <?php echo Form::file('images[]', ['class' => 'input-file', 'id'=>'images', 'multiple']); ?>

            <label for="images" class="btn btn-danger js-labelFile" data-toggle="tooltip" data-original-title="Work Image">
              <i class="icon fa fa-check"></i>
              <span class="js-fileName">Choose Files</span>
            </label>

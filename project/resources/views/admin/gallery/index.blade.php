...
@section('content')
  <div class="content-main-block  mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="{{route('gallery.create')}}" class="btn btn-danger btn-md">Add Gallery</a>
    <!-- Delete Modal -->
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              {!! Form::open(['method' => 'POST', 'action' => 'GalleryController@bulk_delete', 'id' => 'bulk_delete_form']) !!}
          ...
          <tbody>
            @foreach ($gallery as $key => $item)
              <tr>
                ...
                <td>
                  @if ($item->image != null)
                    <img src="{{ asset('images/gallery/'.$item->image) }}" class="img-responsive" width="80" alt="image">
                  @else
                    N/A  
                  @endif
                </td>
                ...
                <td>
                  <div class="admin-table-action-block">
                    <a href="{{route('gallery.edit', $item->id)}}" data-toggle="tooltip" data-original-title="Edit" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
                    <!-- Delete Modal -->

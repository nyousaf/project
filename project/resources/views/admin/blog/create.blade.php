...
@section('content')
  <div class="admin-form-main-block mrgn-t-40">
    <h4 class="admin-form-text"><a href="{{url('admin/blog')}}" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Add Blog Post</h4> 
          {!! Form::open(['class' => 'upload-form', 'method' => 'POST', 'action' => 'BlogController@store', 'files' => true]) !!}
      ...
      <div class="row admin-form-block z-depth-1">
        <div class="col-md-12">
          ...
          <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }} input-file-block">
            ...
            {!! Form::file('image', ['class' => 'input-file', 'id'=>'image','required']) !!}
